...
public class Controller implements Initializable {
    ...
    private static final String DISC_COLOR_1="#24303E";
    private static final String DISC_COLOR_2="#4CAA88";
    ...
    private void gameOver(){
        ...
        Platform.runLater(()->{
            ...
            if( btnClicked.isPresent() && btnClicked.get() == yesBtn ){
                //user took yes to reset the game
                resetGame();
            }else {
                //user said no so exit the game
                Platform.exit();
                System.exit(0);
            }
        });
    ...
    private static class Disc extends Circle{
        ...
        public Disc(boolean isPlayerOneMove){
            ...
            setFill(isPlayerOneMove? Color.valueOf(DISC_COLOR_1): Color.valueOf(DISC_COLOR_2));
